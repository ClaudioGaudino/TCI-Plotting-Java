...
import event.EventIdentifierOld;
import gui.CrosshairListener;
...
public class AccelerometerPlot extends JFrame {
    public AccelerometerPlot(XYSeriesCollection datasetAcc, XYSeriesCollection datasetAngVel) {
        ...
        //XYSeries[] accContacts = event.EventIdentifier.getContactEvents(datasetAcc.getSeries(0), datasetAngVel.getSeries(0), true);
        //XYSeries[] accContacts = event.EventIdentifier.getContactEvents(datasetAcc.getSeries(0), 3, 0.2, 8);
        ...
        //XYSeries[] angContacts = event.EventIdentifier.getContactEvents(datasetAcc.getSeries(0), datasetAngVel.getSeries(0), false);
        ...
        /*saveButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    utils.CSVInterpeter.write_contacts(accContacts, angContacts, "results/contacts.csv");
